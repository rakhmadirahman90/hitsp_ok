    ...
    <div class="main-grid">
        ...
        <div class="sidebar-box">
            ...
            <div class="sidebar-menu">
                <?php $__empty_1 = true; $__currentLoopData = $masterplans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="#"
                   class="menu-item"
                   onclick="showPDF('<?php echo e(asset('storage/masterplan/'.$mp->file)); ?>', this)">
                    <?php echo e($mp->judul); ?>
        ...
        <div class="content-box">
            <?php if($masterplans->count() > 0): ?>
            <iframe id="pdfViewer"
                src="<?php echo e(asset('storage/masterplan/'.$masterplans->first()->file)); ?>"
                class="pdf-viewer">
            </iframe>
            <?php else: ?>
...
<?php echo $__env->make('user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/hitspbiz/public_html/HITSP/resources/views/user/masterplane.blade.php ENDPATH**/ ?>