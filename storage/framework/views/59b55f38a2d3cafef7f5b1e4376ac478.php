<?php $__env->startSection('title', 'Kelola Laporan'); ?>
...
<!-- CUSTOM CSS -->
<link rel="stylesheet" href="<?php echo e(asset('css/admin/laporan.css')); ?>">
<style>
/* ================= BODY ================= */
body {
    background: #f4f6f9;
...
<tr>
    ...
    <td data-label="Ticket No">
        <?php echo e($laporan->ticket_no ?? $laporan->id); ?>

    </td>

    <td data-label="Nama Pengirim">
        <?php echo e($laporan->nama_pengirim); ?>

    </td>

    <td data-label="Status Pengirim">
        <?php echo e($laporan->status_pengirim); ?>
    ...
    <td data-label="Aksi">
        <div class="action-buttons">
            ...
            <a href="<?php echo e(route('admin.laporan.show', $laporan->id)); ?>" 
               class="btn btn-info btn-sm">
               <i class="fa-solid fa-eye"></i>
            </a>

            <?php if($laporan->status == 'Pending'): ?>
            <form action="<?php echo e(route('admin.laporan.terima', $laporan->id)); ?>" 
            ...
            <button type="button" 
                    ...
                    onclick="openDeleteModal('<?php echo e(route('admin.laporan.destroy', $laporan->id)); ?>')">
...
<?php echo $__env->make('operator.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/hitspbiz/public_html/HITSP/resources/views/admin/kelola_laporan.blade.php ENDPATH**/ ?>