...
<form action="<?php echo e(route('admin.user.approve',$user->id)); ?>" method="POST">
<?php echo csrf_field(); ?>
...
<button
onclick='openEditModal(<?php echo json_encode($user, 15, 512) ?>)'
...
<button
onclick="openConfirm(<?php echo e($user->id); ?>)"
...
<form
id="deleteForm<?php echo e($user->id); ?>"
...
<h4><?php echo e($user->nama ?? $user->name); ?></h4>

<p><b>Username :</b> <span class="val-data"><?php echo e($user->username); ?></span></p>

<p><b>Email :</b> <span class="val-data"><?php echo e($user->email); ?></span></p>

<p><b>Role :</b> <span class="val-data"><?php echo e($user->role); ?></span></p>
...
<?php elseif($user->status == 'approved' || $user->status == 'Approved'): ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/hitspbiz/public_html/HITSP/resources/views/admin/kelolapengguna.blade.php ENDPATH**/ ?>