...
<link rel="stylesheet" href="<?php echo e(asset('css/admin/keloladashboard.css')); ?>">
...
<div class="admin-dashboard">
    ...
    <?php $__currentLoopData = $layanans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $layanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="service-card" data-id="<?php echo e($layanan->id); ?>"

            data-nama="<?php echo e($layanan->nama); ?>"

            data-icon="<?php echo e($layanan->icon); ?>">

            <i class="<?php echo e(trim($layanan->icon)); ?>" style="font-size:36px;color:#1B3B5F"></i>
    ...
    <div class="section">
        ...
        <div class="list-box" id="pengumumanList">
            ...
            <?php $__currentLoopData = $pengumumans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="list-item" data-id="<?php echo e($p->id); ?>" data-isi="<?php echo e($p->isi); ?>"  data-tanggal="<?php echo e($p->tanggal); ?>">

                    <span><?php echo e($p->isi); ?> (<?php echo e($p->tanggal); ?>)</span>
    ...
    <div class="section">
        ...
        <div class="activity-grid" id="kegiatanGrid">
            ...
            <?php $__currentLoopData = $kegiatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="activity-card" data-id="<?php echo e($k->id); ?>">

                    <img src="<?php echo e(asset('storage/'.$k->gambar)); ?>">

                    <h4><?php echo e($k->judul); ?></h4>

                    <p class="deskripsi-text"><?php echo e($k->deskripsi); ?></p>
...
document.getElementById('addService').onclick = () => {
    ...
    openModal({
        ...
        onConfirm: () => {
            ...
            fetch('<?php echo e(route("admin.layanan.store")); ?>', {
...
document.getElementById('addPengumuman').onclick = () => {
    ...
    openModal({
        ...
        onConfirm: () => {
            ...
            fetch('<?php echo e(route("admin.pengumuman.store")); ?>', {
...
document.getElementById('addKegiatan').onclick = () => {
    ...
    openModal({
        ...
        onConfirm: () => {
            ...
            fetch('<?php echo e(route("admin.kegiatan.store")); ?>', {
...
<?php echo $__env->make($layout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/hitspbiz/public_html/HITSP/resources/views/admin/keloladashboard.blade.php ENDPATH**/ ?>