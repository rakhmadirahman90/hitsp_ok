<?php $__env->startSection('title', 'Detail Permohonan Hotspot'); ?>

<?php $__env->startSection('content'); ?>
<link rel="stylesheet" href="<?php echo e(asset('css/admin/hotspot.css')); ?>">
...
<div class="hotspot-detail">
    <div class="detail-wrapper bg-white p-4 shadow-sm" style="border-radius: 15px;">
        <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
            ...
            <a href="<?php echo e(route('admin.hotspot.index')); ?>" class="btn btn-sm btn-outline-secondary px-3 py-2 fw-bold">
        ...
        <div class="table-responsive">
            <table class="table table-bordered align-middle">
                <tr class="bg-light">
                    ...
                    <td class="p-3 fw-bold text-dark fs-6"><?php echo e($hotspot->nama_lengkap); ?></td>
                </tr>
                <tr>
                    <th class="p-3 text-secondary text-uppercase small fw-bold">Jabatan / NIM</th>
                    <td class="p-3 text-dark"><?php echo e($hotspot->jabatan); ?> (<?php echo e($hotspot->nip); ?>)</td>
                </tr>
                <tr class="bg-light">
                    <th class="p-3 text-secondary text-uppercase small fw-bold">Kontak Pemohon</th>
                    <td class="p-3 text-dark">
                        <div class="mb-1"><i class="fa fa-envelope me-2 text-muted"></i> <?php echo e($hotspot->email); ?></div>
                        <div><i class="fa fa-phone me-2 text-muted"></i> <?php echo e($hotspot->no_telepon); ?></div>
                    </td>
                </tr>
                <tr>
                    <th class="p-3 text-secondary text-uppercase small fw-bold">Akses & Nama Hotspot</th>
                    <td class="p-3">
                        <span class="text-dark fw-semibold"><?php echo e($hotspot->akses); ?></span> - 
                        <span class="badge bg-light text-primary border border-primary-subtle px-2"><?php echo e($hotspot->nama_hotspot); ?></span>
                    </td>
                </tr>
                <tr class="bg-light">
                    ...
                    <td class="p-3">
                        <span class="badge bg-info text-dark px-3 py-2 fw-bold" style="font-size: 0.75rem;">
                            <?php echo e(strtoupper($hotspot->akun_hotspot)); ?>
                ...
                <tr>
                    ...
                    <td class="p-3">
                        <div class="p-2 bg-light rounded border-start border-4 border-primary">
                            <strong class="text-dark"><?php echo e($hotspot->pj_nama); ?></strong> <span class="text-muted small">(<?php echo e($hotspot->pj_jabatan); ?>)</span> <br>
                            <small class="text-secondary">NIP: <?php echo e($hotspot->pj_nip); ?> | Telp: <?php echo e($hotspot->pj_telepon); ?></small>
                        </div>
                    </td>
                </tr>
                <tr class="bg-light">
                    ...
                    <td class="p-3">
                        <?php $status = (int)$hotspot->persetujuan; ?>
                        <?php if($status === 0): ?>
        ...
        <?php if((int)$hotspot->persetujuan === 0): ?>
            ...
            <div id="wrapperSetuju" class="p-4 border rounded shadow-sm bg-light">
                ...
                <form method="POST" action="<?php echo e(route('admin.hotspot.storeCredentials', $hotspot->id)); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="username_hotspot" class="form-control border-start-0 ps-0" 
                                       value="<?php echo e($hotspot->nip); ?>" placeholder="Username pemohon..." required>
                            </div>
                        </div>
            ...
            <div id="wrapperTolak" class="p-4 border rounded shadow-sm bg-light" style="display: none;">
                ...
                <form method="POST" action="<?php echo e(route('admin.hotspot.tolak', $hotspot->id)); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
        ...
        <?php elseif((int)$hotspot->persetujuan === 1): ?>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0 small uppercase fw-bold">Diproses pada: <?php echo e($hotspot->updated_at->format('d M Y, H:i')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 bg-white p-3 rounded border mx-0">
                        <div class="col-md-4 border-end">
                            ...
                            <span class="fs-5 fw-bold text-primary font-monospace"><?php echo e($hotspot->username_hotspot); ?></span>
                        </div>
                        <div class="col-md-4 border-end">
                    ...
                    <div class="mt-3 p-2 text-center small text-secondary italic">
                        <i class="fa fa-info-circle text-primary me-1"></i> Detail login telah dikirimkan secara otomatis ke email <strong><?php echo e($hotspot->email); ?></strong>.
                    </div>
                </div>
            </div>

        
        <?php elseif((int)$hotspot->persetujuan === 2): ?>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0 small uppercase fw-bold">Sistem memproses penolakan pada <?php echo e($hotspot->updated_at->format('d/m/Y H:i')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 bg-white p-3 rounded border mx-0">
                        ...
                        <div class="col-md-8 text-start ps-4">
                            ...
                            <p class="mb-0 text-dark fw-semibold italic">"<?php echo e($hotspot->alasan_tolak ?? 'Tidak ada catatan tambahan.'); ?>"</p>
                        </div>
                    </div>

                    <div class="mt-3 p-2 text-center small text-secondary italic">
                        <i class="fa fa-info-circle text-danger me-1"></i> Detail informasi penolakan telah dikirimkan secara otomatis ke email <strong><?php echo e($hotspot->email); ?></strong>.
                    </div>
                </div>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('operator.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/hitspbiz/public_html/HITSP/resources/views/admin/detailhotspot.blade.php ENDPATH**/ ?>