<?php $__env->startSection('title', 'Kelola Visi & Misi'); ?>

<link rel="stylesheet" href="<?php echo e(asset('css/admin/visimisi.css')); ?>">
...
<form action="<?php echo e(route('admin.visimisi.store')); ?>" method="POST">
<?php echo csrf_field(); ?>
...
<?php echo e(old('misi.'.$index, $misi)); ?>
...
<?php echo $__env->make('operator.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/hitspbiz/public_html/HITSP/resources/views/admin/visimisi.blade.php ENDPATH**/ ?>