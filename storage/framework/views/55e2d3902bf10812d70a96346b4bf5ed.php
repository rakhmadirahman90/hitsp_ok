...
<td><?php echo e($requests->firstItem() + $i); ?></td>

<td><?php echo e($req->nama); ?></td>

<td><?php echo e($req->jenis_kegiatan); ?></td>

<td>
    <?php echo e(date('d/m/Y', strtotime($req->tanggal))); ?>
...
<td>
    ...
    <a href="<?php echo e(route('admin.zoom.show',$req->id)); ?>"
    ...
    <?php if($req->status == 'active' || $req->status == 'approved'): ?>

    <form action="<?php echo e(route('admin.zoom.disable',$req->id)); ?>"
          method="POST"
    ...
    <form action="<?php echo e(route('admin.zoom.delete',$req->id)); ?>"
          method="POST"
          style="display:inline;">
...
<div class="zoom-card">
    ...
    <h4><?php echo e($req->nama); ?></h4>

    <p>
        <b>Kegiatan:</b>
        <?php echo e($req->jenis_kegiatan); ?>
...
<?php echo $__env->make('operator.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/hitspbiz/public_html/HITSP/resources/views/admin/kelolazoom.blade.php ENDPATH**/ ?>