<?php $__env->startSection('title', 'Permohonan Sub Domain & Hosting'); ?>
        ...
        <div class="card-body">
            ...
            <div class="table-wrapper">
                ...
                <table class="table">
                    ...
                    <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $subdomains; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                            <td><?php echo e($index + 1); ?></td>

                            <td><?php echo e($item->nama_organisasi); ?></td>

                            <td><?php echo e($item->jenis_domain); ?></td>

                            <td><?php echo e($item->nama_teknis); ?></td>

                            <td><?php echo e($item->email_teknis); ?></td>

                            <td><?php echo e($item->nama_sub_domain); ?></td>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(route('admin.subdomain.show', $item->id)); ?>"
                                ...
                                <button type="button" 
                                        ...
                                        data-organisasi="<?php echo e($item->nama_organisasi); ?>"
                                        data-jenis="<?php echo e($item->jenis_domain); ?>"
                                        data-pemohon="<?php echo e($item->nama_teknis); ?>"
                                        data-email="<?php echo e($item->email_teknis); ?>"
                                        data-subdomain="<?php echo e($item->nama_sub_domain); ?>"
                                        data-status="<?php echo e($item->status); ?>"
                                        data-ipserver="<?php echo e($item->ip_server ?? ''); ?>"
                                        data-usersh="<?php echo e($item->user_ssh ?? ''); ?>"
                                        data-passssh="<?php echo e($item->password_ssh ?? ''); ?>"
                                        data-dbname="<?php echo e($item->database_name ?? ''); ?>"
                                        data-dbuser="<?php echo e($item->database_user ?? ''); ?>"
                                        data-dbpass="<?php echo e($item->database_password ?? ''); ?>"
                                        data-path="<?php echo e($item->lokasi_aplikasi ?? ''); ?>">
                                ...
                                <form action="<?php echo e(route('admin.subdomain.disable', $item->id)); ?>"
                                      method="POST"
                                    ...
                                    <button type="submit"
                                            ...
                                            data-name="<?php echo e($item->nama_sub_domain); ?>">
                                ...
                                <form action="<?php echo e(route('admin.subdomain.destroy', $item->id)); ?>"
                                      method="POST"
                                      style="display:inline;">
            ...
            <div class="pagination-wrapper">
                <?php echo e($subdomains->links('pagination::bootstrap-5')); ?>

            </div>
            
            <div class="mobile-cards">

                <?php $__empty_1 = true; $__currentLoopData = $subdomains ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

                <div class="sub-card">

                    <h4><?php echo e($item->nama_sub_domain); ?></h4>

                    <p>
                        <b>Organisasi:</b>
                        <?php echo e($item->nama_organisasi); ?>

                    </p>

                    <p>
                        <b>Jenis:</b>
                        <?php echo e($item->jenis_domain); ?>

                    </p>

                    <p>
                        <b>Pemohon:</b>
                        <?php echo e($item->nama_teknis); ?>

                    </p>

                    <p>
                        <b>Email:</b>
                        <?php echo e($item->email_teknis); ?>
...
<?php echo $__env->make('operator.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/hitspbiz/public_html/HITSP/resources/views/admin/kelolahosting.blade.php ENDPATH**/ ?>