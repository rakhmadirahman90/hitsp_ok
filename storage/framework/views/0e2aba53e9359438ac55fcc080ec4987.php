...
<link rel="stylesheet" href="<?php echo e(asset('css/user/emailpribadi.css')); ?>">
...
<?php elseif($statusCheck === 'approved' || $statusCheck === 'active' || $statusCheck === 'disetujui'): ?>
...
<?php else: ?>
    ...
    <form method="POST" action="<?php echo e(route('email-pribadi.store')); ?>" enctype="multipart/form-data" id="mainFormPribadi">
    <?php echo csrf_field(); ?>
    ...
    <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap', $user->name)); ?>" readonly required>
    </div>
    ...
    <input type="text" name="nomor_identitas" value="<?php echo e(old('nomor_identitas', $user->username ?? '')); ?>" readonly required>
    </div>
    </div>
    ...
    <input type="email" name="email_alternatif" value="<?php echo e(old('email_alternatif', $user->email)); ?>" readonly required>
    </div>
    </div>
   ...
   <span id="emailDomain">
    <?php echo e($user->institution_domain); ?>.ac.id
</span>
    </div>
    <input
    type="hidden"
    name="email_domain"
    id="emailDomainInput"
    value="<?php echo e($user->institution_domain); ?>.ac.id">
    </div>
    </div>
...
const domain = "<?php echo e($user->institution_domain ?? 'institusi'); ?>";
...
<?php echo $__env->make('user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/hitspbiz/public_html/HITSP/resources/views/user/akunemailpribadi.blade.php ENDPATH**/ ?>