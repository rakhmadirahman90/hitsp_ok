...
<aside class="sidebar">
   ...
   <ul class="menu">
    ...
    <li>
        <a href="<?php echo e(route('admin.kelolapengguna')); ?>"
           class="<?php echo e(request()->routeIs('admin.kelolapengguna') ? 'active' : ''); ?>">
...
</html><?php /**PATH /home/hitspbiz/public_html/HITSP/resources/views/admin/layout.blade.php ENDPATH**/ ?>