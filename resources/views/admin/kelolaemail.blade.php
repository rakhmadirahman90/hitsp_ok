    ...
    <div id="emailPribadiTable" class="table-wrapper">
        <table class="table">
            ...
            <tbody>
                ...
                @forelse($emailPribadi as $i => $email)
                ...
                <tr>
                    ...
                    <td>
    @if($email->jenis_pemohon == 'pegawai')
        Dosen / Staf
    @elseif($email->jenis_pemohon == 'mahasiswa')
        Mahasiswa
    @else
        -
    @endif
                    ...
                    <td>{{ $email->fakultas }} / {{ $email->jurusan }}</td>

                    <td>{{ $email->nomor_identitas }}</td>
                    ...
                    <td>
                        ...
                        <a href="{{ route('admin.emailpribadi.detail', $email->id) }}"
                        ...
                        <form action="{{ route('admin.emailpribadi.destroy', $email->id) }}"
                              method="POST"
    ...
    <div id="emailLembagaTable" style="display:none;">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @forelse($emailLembaga as $i => $email)
                ...
                <tr>
                    ...
                    <td>
                        {{ $email->nama_institusi }}
                        {{ $email->nama_kegiatan ? '/ '.$email->nama_kegiatan : '' }}
                    </td>
                    ...
                    <td>
                        ...
                        <a href="{{ route('admin.email.detail', $email->id) }}"
                           class="action-btn detail-btn">
                        ...
                        <form action="{{ route('admin.email.destroy', $email->id) }}"
                              method="POST"
                              style="display:inline;">
                            ...
                            <button type="button"
                                    class="action-btn delete-btn btn-delete"
                                    data-name="{{ $email->nama_institusi }}">
