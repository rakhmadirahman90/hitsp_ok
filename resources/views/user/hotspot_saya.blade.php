...
@section('title', 'Form Registrasi Pengguna Hotspot')

@section('content')

<link rel="stylesheet" href="{{ asset('css/user/hotspot_form.css') }}">

<div class="form-wrapper">

    <h2 class="form-title">Form Registrasi Pengguna Hotspot</h2>

    {{-- Penanganan Error dari Laravel Validation --}}
    @if ($errors->any())
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <select name="akses" required>
                    ...
                    <option value="Lembaga" {{ old('akses') == 'Lembaga' ? 'selected' : '' }}>Lembaga/Fakultas/Jurusan</option>
                    <option value="Dosen" {{ old('akses') == 'Dosen' ? 'selected' : '' }}>Dosen</option>
                    <option value="Staf" {{ old('akses') == 'Staf' ? 'selected' : '' }}>Staf</option>
                    <option value="Mahasiswa" {{ old('akses') == 'Mahasiswa' ? 'selected' : '' }}>Mahasiswa</option>
                    <option value="Lain-lain" {{ old('akses') == 'Lain-lain' ? 'selected' : '' }}>Lain-lain</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    name="nama_lengkap" 
                    value="{{ old('nama_lengkap', Auth::user()->name) }}"                    placeholder="Masukkan nama lengkap" 
                    pattern="[A-Za-z\s.,'-]+"
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input 
                        type="text" 
                        name="nip" 
                        value="{{ old('nip', Auth::user()->username) }}"
            ...
            <div class="form-group">
                ...
                <select name="akun_hotspot" required>
                    ...
                    <option value="Pengguna Baru" {{ old('akun_hotspot') == 'Pengguna Baru' ? 'selected' : '' }}>Pengguna Baru</option>
                    <option value="Reset Password" {{ old('akun_hotspot') == 'Reset Password' ? 'selected' : '' }}>Reset Password</option>
                </select>
            </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    name="nama_hotspot" 
                    value="{{ old('nama_hotspot', 'Nama institusi/kampus') }}" 
...
<div class="form-group">
    ...
    <input 
        type="text" 
        name="pj_nama" 
        value="{{ old('pj_nama', $adminDefault['pj_nama']) }}" 
...
<div class="form-row">
    ...
    <div class="form-group">
        ...
        <input 
            type="text" 
            name="pj_nip" 
            value="{{ old('pj_nip', $adminDefault['pj_nip']) }}" 
    ...
    <div class="form-group">
        ...
        <input 
            type="text" 
            name="pj_jabatan" 
            value="{{ old('pj_jabatan', $adminDefault['pj_jabatan']) }}" 
            placeholder="Masukkan jabatan"
            pattern="[A-Za-z\s.,'-]+"
            oninput="this.value=this.value.replace(/[^A-Za-z\s.,'-]/g,'')"
            required>
...
<div class="form-group">
    ...
    <input 
        type="text" 
        name="pj_telepon" 
        value="{{ old('pj_telepon', $adminDefault['pj_telepon']) }}" 
        placeholder="Masukkan no tlp"
        maxlength="12"
        inputmode="numeric"
        pattern="[0-9]{8,12}"
