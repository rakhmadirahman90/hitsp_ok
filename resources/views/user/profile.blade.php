...
<div class="profile-page">
    ...
    <div class="profile-card">
		...
		<p class="institution">Institusi : {{ $user->institution ?? '-' }}
		</p>
		<p class="institution">
   			 Domain Email : {{ $user->institution_domain ?? '-' }}.ac.id
		</p>
                <p class="role">
                    Status: {{ ucfirst($user->role) }}
                </p>
            </div>
        </div>
...
<div>
    ...
    <input type="text"
        ...
        value="{{ old('institution_domain', $user->institution_domain) }}"
