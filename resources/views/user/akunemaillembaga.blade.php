...
<link rel="stylesheet" href="{{ asset('css/user/emaillembaga.css') }}">
...
<div class="form-wrapper">
    ...
    {{-- SANITASI VARIABEL STATUS AGAR AMAN DARI DATA NULL --}}
    @php
    ...
    {{-- Notifikasi Error dari Validator Laravel --}}
    @if ($errors->any())
        <script>
    ...
    <form method="POST" action="{{ route('email-lembaga.store') }}" id="emailForm">
        @csrf
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    name="nama_institusi" 
                    value="{{ old('nama_institusi', $email->nama_institusi ?? '') }}" 
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    name="nama_kegiatan" 
                    value="{{ old('nama_kegiatan', $email->nama_kegiatan ?? '') }}" 
    ...
    <input
        ...
        name="nama_akun"
        id="nama_akun"
        value="{{ old('nama_akun', $email->nama_akun ?? '') }}"
    ...
    <span>{{ auth()->user()->institution_domain ?? 'institusi' }}.ac.id</span>
</div>
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    id="email_alternatif" 
                    value="{{ old('email_alternatif', $email->email_alternatif ?? $teknis['email_alternatif'] ?? '') }}" 
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    name="nama_teknis" 
                    value="{{ old('nama_teknis', $email->nama_teknis ?? $teknis['nama_teknis'] ?? '') }}"
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    value="{{ old('nip_nik_nim_teknis', $email->nip_nik_nim_teknis ?? $teknis['nip_nik_nim_teknis'] ?? '') }}" 
                    minlength="8"
                    maxlength="18"
                    inputmode="numeric"
                    pattern="[0-9]+"
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    name="jabatan_teknis" 
                    value="{{ old('jabatan_teknis', $email->jabatan_teknis ?? '') }}"
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    name="status_teknis" 
                    value="{{ old('status_teknis', $email->status_teknis ?? '') }}"
            ...
            <div class="form-group">
                ...
                <input 
                    type="text"
                    name="telp_teknis"
                    value="{{ old('telp_teknis', $email->telp_teknis ?? '') }}"
                    minlength="8"
                    maxlength="12"
                    inputmode="numeric"
                    pattern="^[0-9]{8,12}$"
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    name="nama_admin" 
                    value="{{ old('nama_admin', $email->nama_admin ?? $admin['nama_admin'] ?? '') }}" 
                    placeholder="Masukkan nama lengkap"
                    pattern="[A-Za-z\s.,'-]+"
                    oninput="this.value=this.value.replace(/[^A-Za-z\s.,'-]/g,'')"
                    {{ $isLocked ? 'readonly' : '' }}
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    name="nip_admin" 
                    value="{{ old('nip_admin', $email->nip_admin ?? $admin['nip_admin'] ?? '') }}" 
                    minlength="8"
                    maxlength="18"
                    inputmode="numeric"
                    pattern="[0-9]+"
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    name="jabatan_admin" 
                    value="{{ old('jabatan_admin', $email->jabatan_admin ?? $admin['jabatan_admin'] ?? '') }}" 
                    placeholder="Masukkan jabatan"
                    pattern="[A-Za-z\s.,'-]+"
                    oninput="this.value=this.value.replace(/[^A-Za-z\s.,'-]/g,'')"
                    {{ $isLocked ? 'readonly' : '' }}
            ...
            <div class="form-group">
                ...
                <input 
                    type="text"
                    name="telp_admin"
                    value="{{ old('telp_admin', $email->telp_admin ?? $admin['telp_admin'] ?? '') }}" 
                    minlength="8"
                    maxlength="12"
                    inputmode="numeric"
                    pattern="^[0-9]{8,12}$"
        ...
        <div class="form-section">
            ...
            <div class="form-checkbox">
                <input type="checkbox" name="agreement" id="agreement" value="1" {{ $isLocked ? 'disabled checked' : '' }} required>
        ...
        <div class="form-action">
            <button type="submit" id="btnSubmit" {{ $isLocked ? 'disabled' : '' }}>
                Kirim Permohonan
            </button>
        </div>
...
document.addEventListener("DOMContentLoaded",function(){
    ...
    const statusClean = "{{ $statusClean }}";
    const isFormLocked = {{ $isLocked ? 'true' : 'false' }};
    
    // ================= KODE BARU: MODAL NOTIFIKASI AKSES TERKUNCI (FULL MODAL ALERT) =================
    if (isFormLocked && !{{ session('success') ? 'true' : 'false' }}) {
        ...
        if (statusClean === 'disetujui' || statusClean === 'approved' || statusClean === 'active') {
            ...
            let alasan = "{{ $email->alasan_tolak ?? 'uuguyyyyyyyyyyyyyyyyyyyy' }}";
