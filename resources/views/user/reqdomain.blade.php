...
<form id="domainForm" class="domain-form" action="{{ route('requestdomain.store') }}" method="POST">
@csrf
...
value="{{ $adminDefault['alamat_kantor'] }}">
</div>

<div class="form-group">
<label>Alamat Rumah</label>
<input type="text" name="alamat_rumah_admin" required
value="{{ $adminDefault['alamat_rumah'] }}">
</div>
...
value="{{ $adminDefault['telp_kantor'] }}"
inputmode="numeric"
...
{{-- ========================================================================= --}}
{{-- KODE BARU TAMBAHAN: HANDLER POPUP NOTIFIKASI REALTIME (SWEETALERT2)     --}}
{{-- ========================================================================= --}}
@if(session('success'))
<script>
Swal.fire({
