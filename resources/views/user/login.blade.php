        ...
        <form action="{{ route('login.submit') }}" method="POST">
            ...
            <div class="input-field">
               ...
               <input 
                 ...
                 value="{{ old('username') }}" required autofocus maxlength="18" pattern="[0-9]{1,18}"inputmode="numeric"oninput="this.value=this.value.replace(/[^0-9]/g,'').slice(0,18);"title="Username hanya boleh angka maksimal 18 digit">           
              </div>
